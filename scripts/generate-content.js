...
const syllabusTopics = {
  ...
  "unit3": {
    1: {
      ...
      asTip: "২ নম্বৰের প্ৰশ্নৰ বাবে পৰিৱেশ শিক্ষাৰ চমু সংজ্ঞা লিখক: 'পৰিৱেশ শিক্ষা হৈছে পৰিৱেশ সংৰক্ষণৰ বাবে জ্ঞান, সচেতনতা, মনোভাৱ আৰু দক্ষতা বিকাশৰ প্ৰক্ৰিয়া।'",
      enQuestions: [
        "What is Environment?",
    ...
    4: {
      ...
      asTip: "জনসংখ্যা শিক্ষাৰ ৭টা মূল বৈশিষ্ট্য মনত ৰাখক (PIVPFSD মনত ৰাখিব): সমস্যা-কেন্দ্ৰিক, আন্তঃবিষয়ক, মূল্যবোধ-ভিত্তিক, ব্যৱহাৰিক, ভৱিষ্যমুখী, সামাজিকভাৱে প্ৰাসংগিক আৰু সিদ্ধান্ত-মুখী।",
      enQuestions: [
    ...
    5: {
      ...
      asExplanation: "জনসংখ্যা শিক্ষাৰ পৰিসৰত জনসংখ্যা বৃদ্ধিৰ ধাৰা, পাৰিবাৰিক জীৱন, স্বাস্থ্য, পুষ্টি আৰু পৰিৱেশৰ সম্বন্ধ অন্তৰ্ভুক্ত। অতি কম সময়ৰ ভিতৰত জনসংখ্যাৰ দ্ৰুত আৰু অনিয়ন্ত্ৰিত বৃদ্ধিক জনসংখ্যা বিস্ফোৰণ বোলে। ইয়াৰ মূল কাৰণসমূহ হ'ল উচ্চ জন্মহাৰ, মৃত্যুহাৰ হ্ৰাস, বাল্যবিবাহ, দৰিদ্ৰতা আৰু নিৰক্ষৰতা।",
      enPoints: [
      ...
      asPoints: [
        ...
        "কাৰণসমূহ: উচ্চ জন্মহাৰ, বাল্যবিবাহ, পৰিয়াল পৰিকল্পনাৰ অভাৱ, দৰিদ্ৰতা, নিৰক্ষৰতা, মৃত্যুহাৰ হ্ৰাস আৰু সামাজিক অন্ধবিশ্বাস।",
    ...
    7: {
      ...
      asPoints: [
        ...
        "বৈশিষ্ট্যসমূহ: মূল্যবোধ-ভিত্তিক, সৰ্বাংগীণ ব্যক্তিত্ব বিকাশ, এক নিৰন্তৰ আজীৱন প্ৰক্ৰিয়া, ব্যৱহাৰিক প্ৰকৃতিৰ আৰু আচৰণ-কেন্দ্ৰিক।"
      ],
    ...
    9: {
      ...
      asExplanation: "মহিলা সবলীকৰণ হৈছে মহিলাসকলক আত্মবিশ্বাস, অধিকাৰ, সুযোগ আৰু সিদ্ধান্ত গ্ৰহণৰ ক্ষমতা লাভ কৰাত সহায় কৰাৰ প্ৰক্ৰিয়া। শিক্ষা হ'ল ইয়াৰ আটাইতকৈ কাৰ্যকৰী মাধ্যম যিয়ে জ্ঞান প্ৰদান কৰে, অৰ্থনৈতিক স্বতন্ত্ৰতা দিয়ে, নেতৃত্বৰ গুণ বিকাশ কৰে আৰু শোষণৰ পৰা সুৰক্ষিত কৰে। কিন্তু ই দৰিদ্ৰতা, লিংগ বৈষম্য, বাল্যবিবাহ আৰু অভিভাৱকৰ নিৰক্ষৰতাৰ দৰে বাধাৰ সন্মুখীন হয়।",
      enPoints: [
